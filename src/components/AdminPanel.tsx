...
import { Shield, Trash2, UserPlus, AlertTriangle, RefreshCw, Edit, Users } from 'lucide-react';
...
export function AdminPanel({ currentEpisode, onClearScores, onClearEpisodeScores, onClearHistory, onResetAll, onNewSeason }: AdminPanelProps) {
  ...
  const cleanupDuplicates = async () => {
    ...
    try {
      ...
      // For each name with duplicates, delete all but the best one
      const idsToDelete: string[] = [];
      contestantsByName.forEach((contestants, name) => {
        if (contestants.length > 1) {
          // Sort to find the best one: owner > not eliminated > has pick > earliest created
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="Kalin">Kalin</SelectItem>
